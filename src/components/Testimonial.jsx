            ...
            <div className="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
                ...
                <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                    ...
                    <div>
                        ...
                        <p className="mt-0.5 text-lg font-medium text-gray-900">Carine Krikorian</p>
                    </div>
                    </div>
                ...
                <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                    ...
                    <div>
                        ...
                        <p className="mt-0.5 text-lg font-medium text-gray-900">Rick Bolander</p>
                    </div>
                    </div>
                ...
                <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                    ...
                    <div>
                        ...
                        <p className="mt-0.5 text-lg font-medium text-gray-900">Levon Ishag</p>
                    </div>
                    </div>
